...
This project is meant to be easy to read and extend — a basic implementation of how an agent can coordinate planning, tool execution, and structured reasoning to handle an incident from start to finish.
